...
//
//  Created by Lucas Neves dos santos pompeu on 26/07/23.
//
...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func addCaptions() {
        ...
        let rendererImage = renderer.image { [ weak self ] ctx in
    ...
    func drawText(text: String, position: Position, rendererSize: CGSize) {
        ...
        let sideslenght = rendererSize.width + rendererSize.height
        let fontSize = sideslenght / 30
